...
const MAX_TURN_CONTINUATION_DEFAULT_MAX_ATTEMPTS = AGENT_DEFAULT_CONTINUATION_ATTEMPTS;
const MAX_TURN_CONTINUATION_MAX_ATTEMPTS_CAP = 10;
const MAX_TURN_CONTINUATION_DEFAULT_DELAY_MS = AGENT_DEFAULT_CONTINUATION_DELAY_SEC * 1000;
